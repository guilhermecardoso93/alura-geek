...
export async function Products(produtos) {
    ...
    <div className="flex flex-col gap-9  items-center justify-center w-[768px]">
      ...
      <div className="flex flex-wrap gap-2  justify-center">
        {produtos.map((data, index) => {
          <div className="flex flex-col items-start justify-between p-3 bg-[#5d04d9] border-black border-4 rounded-xl text-white mb-7" key={index}>
            <img
              src={data.image}
              alt=""
